...
class Blackjack
  ...
  def dealer_turn
    ...
    puts "Dealer shows #{dealer.cards[0]} for a total of #{dealer.total}"
  ...
  def play_again?
    puts ""
    puts "Would you like to play again? 1) yes 2) nope"
